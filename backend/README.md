...
> Backend service docs. For the project overview and architecture diagrams, see the
> [root README](../README.md). Frontend docs: [`../frontend/README.md`](../frontend/README.md).

This is the FastAPI service: detection engine, explainer, and the practice simulator.
